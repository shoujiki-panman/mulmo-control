...
| 134 | fast | MulmoClaude を起こすモードで、待つポートと開く URL が2箇所で揃っている | ✅ シェルと Swift の対応表を突き合わせ、通常モードが 5173 を待たないこと・設定が無い/壊れているときに開発モードへ倒れること・production serve の2変数と `yarn dev` が消えていないことを見る（#168） |
